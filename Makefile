...
genetic_algorithm.o: modules/genetic_algorithm.cpp modules/genetic_algorithm.h
	$(CXX) -arch arm64 $(GCCFLAGS) $(CXXFLAGS) $(LDFLAGS) $(MODULEFLAGS) genetic_algorithm/genetic_algorithm.cpp
